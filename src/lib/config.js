// ─── ERP base URL ─────────────────────────────────────────────────────────────
export const ERP_BASE_URL = import.meta.env.VITE_ERP_BASE_URL || 'https://erp.loxng.com';

// ─── OAuth client credentials ─────────────────────────────────────────────────
export const OAUTH_CLIENT_ID     = import.meta.env.VITE_OAUTH_CLIENT_ID     || '';
// Client secret: only needed if ERPNext is configured as a confidential client.
// Most Frappe OAuth setups for first-party SPAs use a public client (no secret).
