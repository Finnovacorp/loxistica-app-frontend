...
export default function Callback() {
  ...
  useEffect(() => {
    ...
    if (errParam) {
      setError(
        params.get("error_description") ?? "OAuth error. Please try again.",
      );
      return;
    }
    ...
    (async () => {
      try {
        ...
        const allowed =
          roles.includes("Field Staff") || roles.includes("Operations Manager");

        if (!allowed) {
          setError(
            "Your account has not been set up for access. Please contact your administrator.",
          );
          return;
        }
